package com.hae.eforest.java;

import android.util.Log;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.hae.eforest.java.model.Applicant;
import com.hae.eforest.java.model.DocType;
import com.hae.eforest.java.model.HttpMethod;
import com.hae.eforest.java.model.Metadata;
...
public class AppTokenJavaExample {
    ...
    private static final String SUMSUB_SECRET_KEY = "dh1OpJubkrClT0j8jK3BywnijsakBATI"; // Example: Hej2ch71kG2kTd1iIUDZFNsO5C1lh5Gq
    private static final String SUMSUB_APP_TOKEN = "prd:MciACqgeccqGsGyfkFjh3w6X.LxzhZA9HbeLtq1NsXO5Ie8htOD6VQiIe"; // Example: sbx:uY0CgwELmgUAEyl4hNWxLngb.0WSeQeiYny4WEqmAALEAiK2qTC96fBad
    ...
    public static void getToken() throws IOException, InvalidKeyException, NoSuchAlgorithmException {
        ...
        String applicantId = "msdk2-demo-android-436b6959-923f-4ad4-9288-abf22850a175";
...
//        System.out.println("Applicant status (json string): " + applicantStatusStr);
        ...
        String accessTokenStr = getAccessToken(applicantId, levelName);
    ...
    public static String addDocument(String applicantId, File doc) throws NoSuchAlgorithmException, InvalidKeyException, IOException {
        ...
        RequestBody requestBody = new MultipartBody.Builder()
                ...
                .addFormDataPart("metadata", objectMapper.writeValueAsString(new Metadata(DocType.PASSPORT, "KR")))
    ...
    private static Response sendPost(String url, RequestBody requestBody) throws IOException, InvalidKeyException, NoSuchAlgorithmException {
        ...
        String sig = createSignature(ts, HttpMethod.POST, url, requestBodyToBytes(requestBody));
        Log.d("AppToken AppToken", SUMSUB_APP_TOKEN);
        Log.d("AppToken Sig", sig);
...
//        Log.d("body", body.toString());
        ...
        String encryptStr = (ts + httpMethod.name() + path);
        Log.d("AppToken EncryptStr", encryptStr);
        hmacSha256.update((ts + httpMethod.name() + path).getBytes(StandardCharsets.UTF_8));
        if ( body == null ) {
            return Hex.encodeHexString(hmacSha256.doFinal());
        } else {
            return Hex.encodeHexString(hmacSha256.doFinal(body));
        }
...
//        return Hex.encodeHexString
    ...
    public static byte[] requestBodyToBytes(RequestBody requestBody) throws IOException {
        ...
        Log.d("AppToken ByteArray", buffer.readString(StandardCharsets.UTF_8));
        Log.d("AppToken ByteArray", "bufferSize : " + buffer.size());
